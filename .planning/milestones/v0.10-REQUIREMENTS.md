# Requirements Archive: v0.10 Library-canonical Model + Cross-Machine Plugin Reconciliation
...
- [x] **REL-01**: PRs #484 (chore/v0.10-prep doc drift + safety fixes) and #504 (refactor/v0.10-phase-c type lifts) merged before phase planning starts.
- [x] **REL-02**: Issue triage pass: close already-shipped issues (#392, #365, #396, #459 once retitled, #463); de-dup review-followups vs older refactors (#419/#488, #423/#489, #427/#491, #432/#485, #441/#487, #428+#429/#486).
- [x] **REL-03**: Linux UAT items from v0.8 carry-over re-evaluated: verify on Linux hardware OR document explicit deferral to v1.0.
- [x] **REL-04**: Migration smoke-test on real library (Martin's coding-agent-files dotfiles) — verify 62 symlinks convert cleanly, distribution targets re-symlinked, no skill content lost.
- [x] **REL-05**: cargo-dist release for v0.10.0 (Homebrew + GitHub Releases, signed/notarized for macOS).
...
|-------------|-------|--------------|--------|
| LIB-01 | Phase 11 | #459 | Validated |
| LIB-02 | Phase 11 | #459 | Validated |
| LIB-03 | Phase 11 | #459 | Validated |
| LIB-04 | Phase 11 | #459 | Validated |
| LIB-05 | Phase 11 | #459 | Validated |
| ADP-01 | Phase 12 | — | Validated |
| ADP-02 | Phase 12 | — | Validated |
| ADP-03 | Phase 12 | — | Validated |
| ADP-04 | Phase 12 | — | Validated |
| RECON-01 | Phase 13 | — | Validated |
| RECON-02 | Phase 13 | — | Validated |
| RECON-03 | Phase 13 | — | Validated |
| RECON-04 | Phase 13 | — | Validated |
| RECON-05 | Phase 13 | — | Validated |
...
| REL-01 | Phase 17 | — | Validated |
| REL-02 | Phase 17 | — | Validated |
| REL-03 | Phase 17 | — | Validated |
| REL-04 | Phase 17 | — | Validated |
| REL-05 | Phase 17 | — | Validated |
