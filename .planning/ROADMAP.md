...
- 📋 **Post-v1.0 Skill Evaluation** — Phase 32 starts the harness-independent evaluation foundation from [#602](https://github.com/MartinP7r/tome/issues/602): a provider-neutral deterministic core before any Codex/Claude adapter, model invocation, CLI, or CI gate.
...
- [x] **Phase 27.1: Multi-machine shared pool configuration** (INSERTED) — Separate shared pool policy, versioned machine profiles, and local runtime settings; preserve accumulated skills and provenance across machine-specific source/target topologies; add consent-driven Git synchronization and explicit conflict handling. (completed 2026-08-22)
  **Plans:** 6 plans
  ...
  - [x] 27.1-03-PLAN.md — Accumulating pool, provenance catalog, and explicit conflict handling (POOL-03..05)
  - [x] 27.1-04-PLAN.md — Consent-driven safe Git pull/publish and owned-path staging (POOL-06..07)
  - [x] 27.1-05-PLAN.md — Profile and Git health in CLI status (POOL-08)
  - [x] 27.1-06-PLAN.md — Desktop effective-context, status, and watcher parity (POOL-01, POOL-06, POOL-08)
...
### Phase 27.1: Multi-machine shared pool configuration (INSERTED)
...
**Depends on**: Phase 27.1 (Multi-machine shared pool configuration) — the Configuration UI must target the new pool policy, named machine profile, and local runtime settings contracts rather than the superseded single portable directory map.
