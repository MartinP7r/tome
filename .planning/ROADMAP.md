...
- [ ] 15-01-cli-decomposition-PLAN.md — lib.rs::run() decomposition into cmd_<name> helpers + tests/cli.rs split into per-domain files (HARD-02, HARD-13)
...
| 15. CLI hardening (beta) | v0.10 | 0/6 | Not started | - |
