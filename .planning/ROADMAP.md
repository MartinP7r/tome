...
- [ ] 12-01-PLAN.md — `MarketplaceAdapter` trait + `InstalledPlugin` + `MockMarketplaceAdapter` + module declaration (ADP-01)
- [ ] 12-02-PLAN.md — `InstallFailure` + `InstallOp` + `InstallFailureKind` + ALL/sentinel + `render_install_failures` (ADP-04)
- [ ] 12-03-PLAN.md — `GitAdapter` wrap of `crate::git` helpers (ADP-03)
- [ ] 12-04-PLAN.md — `ClaudeMarketplaceAdapter` with cache, parser, heuristic classifier, smoke tests (ADP-02)
...
| 12. Marketplace adapter | v0.10 | 0/4 | Not started | - |
