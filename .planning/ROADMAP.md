...
**Plans**: 4 plans
  - [ ] 07-01-wux-04-resolved-tome-home-info-PLAN.md — print resolved tome_home + source label at start of tome init (WUX-04)
  - [ ] 07-02-wux-03-legacy-config-detection-PLAN.md — MachineState + has_legacy_sections + legacy cleanup handler (WUX-03)
  - [ ] 07-03-wux-01-05-tome-home-prompt-PLAN.md — Step 0 greenfield tome_home prompt + XDG persist (WUX-01, WUX-05)
